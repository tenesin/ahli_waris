...
<x-filament-panels::layout.base :livewire="$livewire">
    ...
    <div class="fi-simple-layout flex min-h-screen flex-col items-center">
        ...
        <div class="fi-simple-main-ctn flex w-full flex-grow items-center justify-center">
            <main @class([
                'flex flex-column fi-simple-main my-16 w-full bg-white  shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 sm:rounded-xl ',
                match ($maxWidth ?? null) {
                ...
                {{ $slot }}
                <img src="{{ asset('images/auth.side.png') }}" class="w-6/12 object-cover sm:rounded-r-xl hidden sm:block"
                    alt="Login side image" srcset="">
            </main>
        </div>
